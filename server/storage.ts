...
export class MemStorage implements IStorage {
    ...
    const activitiesData: InsertActivity[] = [
      {
        ...
        imageUrl: "/src/public/CapoeiraJourney/image5.jpeg",
        category: "practice",
      },
      {
        ...
        date: "21/05/2025",
        imageUrl: "/src/public/CapoeiraJourney/image6.jpeg",
        category: "practice",
      },
      {
        ...
        date: "19/04/2025",
        imageUrl: "/src/public/CapoeiraJourney/image7.jpeg",
        category: "event",
      },
      {
        ...
        date: "12/06/2025",
        imageUrl: "/src/public/CapoeiraJourney/image8.jpeg",
        category: "event",
      },
    ];
  ...
  async getAllSeminars(): Promise<Seminar[]> {
    return Array.from(this.seminars.values()).sort(
